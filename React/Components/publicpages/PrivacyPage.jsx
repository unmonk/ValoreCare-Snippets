...
export default function PrivacyPage() {
  return (
    <div data-mercury="full" id="privacy_page_content">
      <h3>Registrar</h3>
      <p>
        Valorecare (hereafter referred to as Valore in this document)
        <br />
        <a href="https://valorecare.com">www.valorecare.com</a>
        <br />
        info@valorecare.com
      </p>
      ...
      <h3>
        <p>
          <span style={{ fontWeight: 'normal' }}>
            ...
            the management of Valore. The use of the Internet pages of Valore is
        ...
        <p>
          <span style={{ fontWeight: 'normal' }}>
            ...
            applicable to Valore. By means of this data protection declaration,
            our enterprise would like to inform the general public of the
        ...
        <p>
          <span style={{ fontWeight: 'normal' }}>
            As the controller, Valore has implemented numerous technical and
      ...
      <h3>
        <p>
          <span style={{ fontWeight: 'normal' }}>
            The data protection declaration of Valore is based on the terms used
      ...
      <h3>
        ...
        <p>
          <span style={{ fontWeight: 'normal' }}>
            Email: info@valorecare.com
            <br />
            Website: valorecare.com
          </span>
        </p>
      </h3>
      <h4>3. Cookies</h4>
      <h3>
        <p>
          <span style={{ fontWeight: 'normal' }}>
            The Internet pages of Valore use cookies. Cookies are text files
        ...
        <p>
          <span style={{ fontWeight: 'normal' }}>
            Through the use of cookies, Valore can provide the users of this
      ...
      <h3>
        <p>
          <span style={{ fontWeight: 'normal' }}>
            The website of Valore collects a series of general data and
        ...
        <p>
          <span style={{ fontWeight: 'normal' }}>
            When using these general data and information, Valore does not draw
            ...
            authorities with the information necessary for criminal prosecution
            in case of a cyber-attack. Therefore, Valore analyzes anonymously
            ...
            and to ensure an optimal level of protection for the personal data
            we process. The anonymous data of the server log files are stored
      ...
      <h3>
        <p>
          <span style={{ fontWeight: 'normal' }}>
            ...
            the controller with the indication of personal data. Which personal
            data are transmitted to the controller is determined by the
        ...
        <p>
          <span style={{ fontWeight: 'normal' }}>
            ...
            this is the only way to prevent the misuse of our services, and, if
      ...
      <h3>
        <p>
          <span style={{ fontWeight: 'normal' }}>
            On the website of Valore, users are given the opportunity to
            subscribe to our enterprise’s newsletter. The input mask used for
            this purpose determines what personal data are transmitted, as well
            as when the newsletter is ordered from the controller.
          </span>
        </p>
        <p>
          <span style={{ fontWeight: 'normal' }}>
            Valore informs its customers and business partners regularly by
            means of a newsletter about enterprise offers. The enterprise’s
            newsletter may only be received by the data subject if (1) the data
            subject has a valid e-mail address and (2) the data subject
            registers for the newsletter shipping. A confirmation e-mail will be
            sent to the e-mail address registered by a data subject for the
            first time for newsletter shipping, for legal reasons, in the double
            opt-in procedure. This confirmation e-mail is used to prove whether
            the owner of the e-mail address as the data subject is authorized to
      ...
      <h3>
        <p>
          <span style={{ fontWeight: 'normal' }}>
            The newsletter of Valore contains so-called tracking pixels. A
            tracking pixel is a miniature graphic embedded in such e-mails,
            which are sent in HTML format to enable log file recording and
            analysis. This allows a statistical analysis of the success or
            failure of online marketing campaigns. Based on the embedded
            tracking pixel, Valore may see if and when an e-mail was opened by a
        ...
        <p>
          <span style={{ fontWeight: 'normal' }}>
            ...
            will be deleted by the controller. Valore automatically regards a
      ...
      <h3>
        <p>
          <span style={{ fontWeight: 'normal' }}>
            The website of Valore contains information that enables a quick
      ...
      <h3>
        <p>
          <span style={{ fontWeight: 'normal' }}>
            Valore offers users the possibility to leave individual comments on
            individual blog contributions on a blog, which is on the website of
      ...
      <h3>
        <p>
          <span style={{ fontWeight: 'normal' }}>
            The comments made in the blog of Valore may be subscribed to by
        ...
        <p>
          <span style={{ fontWeight: 'normal' }}>
            ...
            will send an automatic confirmation e-mail to check the double
            opt-in procedure as to whether the owner of the specified e-mail
          ...
          <li>
            ...
            <p>
              <span style={{ fontWeight: 'normal' }}>
                ...
                wishes to request the erasure of personal data stored by Valore,
                he or she may, at any time, contact any employee of the
                controller. An employee of Valore shall promptly ensure that the
            ...
            <p>
              <span style={{ fontWeight: 'normal' }}>
                ...
                employees of Valore will arrange the necessary measures in
                individual cases.
              </span>
            </p>
          </li>
          ...
          <li>
            ...
            <p>
              <span style={{ fontWeight: 'normal' }}>
                ...
                personal data stored by Valore, he or she may at any time
                contact any employee of the controller. The employee of Valore
          ...
          <li>
            ...
            <p>
              <span style={{ fontWeight: 'normal' }}>
                ...
                subject may at any time contact any employee of Valore.
              </span>
            </p>
          </li>
        </ul>
      ...
      <h3>
        <ul>
          <li>
            ...
            <p>
              <span style={{ fontWeight: 'normal' }}>
                Valore shall no longer process the personal data in the event of
            ...
            <p>
              <span style={{ fontWeight: 'normal' }}>
                If Valore processes personal data for direct marketing purposes,
                ...
                the Valore to the processing for direct marketing purposes,
                Valore will no longer process the personal data for these
                purposes.
              </span>
            </p>
            <p>
              <span style={{ fontWeight: 'normal' }}>
                ...
                personal data concerning him or her by Valore for scientific or
            ...
            <p>
              <span style={{ fontWeight: 'normal' }}>
                ...
                contact any employee of Valore. In addition, the data subject is
          ...
          <li>
            ...
            <p>
              <span style={{ fontWeight: 'normal' }}>
                ...
                consent, Valore shall implement suitable measures to safeguard
                the data subject’s rights and freedoms and legitimate interests,
                at least the right to obtain human intervention on the part of
                the controller, to express his or her point of view and contest
                the decision.
              </span>
            </p>
            <p>
              <span style={{ fontWeight: 'normal' }}>
                ...
                time, contact any employee of Valore.
              </span>
            </p>
          </li>
        </ul>
      ...
      <h3>
        ...
        <p>
          <span style={{ fontWeight: 'normal' }}>
            ...
            options Facebook offers to protect the privacy of the data subject.
            In addition, different configuration options are made available to
            allow the elimination of data transmission to Facebook. These
      ...
      <h3>
        <p>
          <span style={{ fontWeight: 'normal' }}>
            ...
            Google AdSense is an online service which allows the placement of
            advertising on third-party sites. Google AdSense is based on an
            algorithm that selects advertisements displayed on third-party sites
            to match with the content of the respective third-party site. Google
            AdSense allows an interest-based targeting of the Internet user,
            which is implemented by means of generating individual user
            profiles.
          </span>
        </p>
        <p>
          <span style={{ fontWeight: 'normal' }}>
            The operating company of Google’s AdSense component is Google
        ...
        <p>
          <span style={{ fontWeight: 'normal' }}>
            ...
            the Google AdSense component for the purpose of online advertising
            and the settlement of commissions to Alphabet Inc. During the course
            of this technical procedure, the enterprise Alphabet Inc. gains
            knowledge of personal data, such as the IP address of the data
            subject, which serves Alphabet Inc., inter alia, to understand the
        ...
        <p>
          <span style={{ fontWeight: 'normal' }}>
            ...
            would also prevent Alphabet Inc. from setting a cookie on the
            information technology system of the data subject. Additionally,
            cookies already in use by Alphabet Inc. may be deleted at any time
        ...
        <p>
          <span style={{ fontWeight: 'normal' }}>
            ...
            tracking pixel is a miniature graphic that is embedded in web pages
            to enable a log file recording and a log file analysis through which
            a statistical analysis may be performed. Based on the embedded
            tracking pixels, Alphabet Inc. is able to determine if and when a
            website was opened by a data subject, and which links were clicked
            on by the data subject. Tracking pixels serve, inter alia, to
        ...
        <p>
          <span style={{ fontWeight: 'normal' }}>
            ...
            accounting of the displayed advertisements—is transmitted to
            Alphabet Inc. in the United States of America. These personal data
            will be stored and processed in the United States of America. The
            Alphabet Inc. may disclose the collected personal data through this
      ...
      <h3>
        <p>
          <span style={{ fontWeight: 'normal' }}>
            ...
            allows an enterprise to display advertising to Internet users who
            have previously resided on the enterprise’s Internet site. The
            integration of Google Remarketing therefore allows an enterprise to
            create user-based advertising and thus shows relevant advertisements
        ...
        <p>
          <span style={{ fontWeight: 'normal' }}>
            ...
            interest-relevant advertising. Google Remarketing allows us to
            display ads on the Google network or on other websites, which are
        ...
        <p>
          <span style={{ fontWeight: 'normal' }}>
            Google Remarketing sets a cookie on the information technology
            system of the data subject. The definition of cookies is explained
            above. With the setting of the cookie, Google enables a recognition
            of the visitor of our website if he calls up consecutive web pages,
            which are also a member of the Google advertising network. With each
            call-up to an Internet site on which the service has been integrated
            by Google Remarketing, the web browser of the data subject
            identifies automatically with Google. During the course of this
            technical procedure, Google receives personal information, such as
            the IP address or the surfing behaviour of the user, which Google
            uses, inter alia, for the insertion of interest relevant
            advertising.
          </span>
        </p>
        <p>
        ...
        <p>
          <span style={{ fontWeight: 'normal' }}>
            ...
            adjustment of the web browser used and thus permanently deny the
            setting of cookies. Such an adjustment to the Internet browser used
            would also prevent Google from setting a cookie on the information
            technology system of the data subject. In addition, cookies already
            in use by Google may be deleted at any time via a web browser or
        ...
        <p>
          <span style={{ fontWeight: 'normal' }}>
            ...
            the interest-based advertising by Google. For this purpose, the data
            subject must call up the link to www.google.com/settings/ads and
            make the desired settings on each Internet browser used by the data
            subject.
          </span>
        </p>
        <p>
      ...
      <h4>
        17. Data protection provisions about the application and use of
        Google-AdWords
      </h4>
      <h3>
        <p>
      ...
      <h4>
        18. Data protection provisions about the application and use of Jetpack
        for WordPress
      </h4>
      <h3>
        <p>
          <span style={{ fontWeight: 'normal' }}>
            ...
            WordPress plug-in, which provides additional features to the
            operator of a website based on WordPress. Jetpack allows the
            Internet site operator, inter alia, an overview of the visitors of
            the site. By displaying related posts and publications, or the
            ability to share content on the page, it is also possible to
            increase visitor numbers. In addition, security features are
            integrated into Jetpack, so a Jetpack-using site is better protected
            against brute-force attacks. Jetpack also optimizes and accelerates
            the loading of images on the website.
          </span>
        </p>
        <p>
          <span style={{ fontWeight: 'normal' }}>
            The operating company of Jetpack Plug-Ins for WordPress is the Aut
        ...
        <p>
          <span style={{ fontWeight: 'normal' }}>
            ...
            which is operated by the controller and on which a Jetpack component
            was integrated, the Internet browser on the information technology
            system of the data subject is automatically prompted to submit data
            through the Jetpack component for analysis purposes to Automattic.
            During the course of this technical procedure Automattic receives
            data that is used to create an overview of website visits. The data
            obtained in this way serves the analysis of the behaviour of the
            data subject, which has access to the Internet page of the
            controller and is analyzed with the aim to optimize the website. The
            data collected through the Jetpack component is not used to identify
            the data subject without a prior obtaining of a separate express
            consent of the data subject. The data comes also to the notice of
            Quantcast. Quantcast uses the data for the same purposes as
            Automattic.
          </span>
        </p>
        <p>
          <span style={{ fontWeight: 'normal' }}>
            The data subject can, as stated above, prevent the setting of
            cookies through our website at any time by means of a corresponding
            adjustment of the web browser used and thus permanently deny the
            setting of cookies. Such an adjustment to the Internet browser used
            would also prevent Automattic/Quantcast from setting a cookie on the
            information technology system of the data subject. In addition,
            cookies already in use by Automattic/Quantcast may be deleted at any
            time via a web browser or other software programs.
          </span>
        </p>
        <p>
          <span style={{ fontWeight: 'normal' }}>
            ...
            generated by the Jetpack cookie as well as the processing of these
            data by Automattic/Quantcast and the chance to preclude any such.
            For this purpose, the data subject must press the ‘opt-out’ button
            under the link https://www.quantcast.com/opt-out/ which sets an
            opt-out cookie. The opt-out cookie set with this purpose is placed
            on the information technology system used by the data subject. If
            the cookies are deleted on the system of the data subject, then the
            data subject must call up the link again and set a new opt-out
            cookie.
          </span>
        </p>
        <p>
        ...
        <p>
          <span style={{ fontWeight: 'normal' }}>
            The applicable data protection provisions of Automattic may be
            accessed under https://automattic.com/privacy/. The applicable data
      ...
      <h3>
        ...
        <p>
          <span style={{ fontWeight: 'normal' }}>
            ...
            the contents of this website to allow our users to introduce this
        ...
        <p>
          <span style={{ fontWeight: 'normal' }}>
            ...
            data subject. This information is collected through the Twitter
            component and associated with the respective Twitter account of the
            data subject. If the data subject clicks on one of the Twitter
            buttons integrated on our website, then Twitter assigns this
        ...
        <p>
          <span style={{ fontWeight: 'normal' }}>
            ...
            occurs regardless of whether the person clicks on the Twitter
            component or not. If such a transmission of information to Twitter
            is not desirable for the data subject, then he or she may prevent
            this by logging off from their Twitter account before a call-up to
            our website is made.
          </span>
        </p>
        <p>
      ...
      <h3>
        ...
        <p>
          <span style={{ fontWeight: 'normal' }}>
            ...
            under https://www.youtube.com/yt/about/en/. During the course of
      ...
      <h3>
        <p>
          <span style={{ fontWeight: 'normal' }}>
            ...
            or other vital information would have to be passed on to a doctor,
      ...
      <h4>
        22. The legitimate interests pursued by the controller or by a third
        party
      </h4>
      <h3>
        <p>
      ...
      <h3>
        ...
        <p>
          <span style={{ fontWeight: 'normal' }}>
            ...
            provide us with personal data when our company signs a contract with
